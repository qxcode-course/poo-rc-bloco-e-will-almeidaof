...
![cover](../../.tko/cache/poo/base/shapes/cover.jpg)
...
![diagrama](../../.tko/cache/poo/base/shapes/diagrama.png)

[![youtube icon](../../.tko/cache/poo/base/shapes/..//yousolver.png)](https://youtu.be/VMHI9mjIwZQ?si=jUgIc0AT9YY3Dc7K)
...
<!-- links .cache/draft -->
- cpp
  - [shell.cpp](../../.tko/cache/poo/base/shapes/.cache/draft/cpp/shell.cpp)
- java
  - [Shell.java](../../.tko/cache/poo/base/shapes/.cache/draft/java/Shell.java)
- ts
  - [shell.ts](../../.tko/cache/poo/base/shapes/.cache/draft/ts/shell.ts)
<!-- links -->
